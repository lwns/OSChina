package com.op.core.weight.loading;
...
import com.op.core.weight.loading.indicators.BallPulseIndicator;
...
public class Loading extends View {
    ...
    public Loading(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, R.style.Loading);
    }

    public Loading(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, R.style.Loading);
    }
