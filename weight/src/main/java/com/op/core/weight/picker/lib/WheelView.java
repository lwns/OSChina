package com.op.core.weight.picker.lib;
...
import com.core.op.weight.R;
import com.op.core.weight.picker.adapter.WheelAdapter;
import com.op.core.weight.picker.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
        textColorOut = getResources().getColor(R.color.picker_wheelview_textcolor_out);
        textColorCenter = getResources().getColor(R.color.picker_wheelview_textcolor_center);
        dividerColor = getResources().getColor(R.color.picker_wheelview_textcolor_divider);
        //配合customTextSize使用，customTextSize为true才会发挥效果
        textSize = getResources().getDimensionPixelSize(R.dimen.picker_text_xlarge);
        customTextSize = true;
        if (attrs != null) {
