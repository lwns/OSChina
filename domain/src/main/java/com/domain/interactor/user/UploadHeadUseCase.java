 ...
 */
public class UploadHeadUseCase extends UseCase<UserV2> {
    UserRepository repository;

    @Inject
    public UploadHeadUseCase(UserRepository repository, ThreadExecutor threadExecutor, PostExecutionThread postExecutionThread) {
