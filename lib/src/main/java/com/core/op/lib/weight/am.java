...
public abstract class am extends ReplacementSpan {
    ...
    private void d() {
        ...
        m = resources
                .getDimensionPixelSize(R.dimen.app_margin_small);
        i = resources
                .getDimensionPixelSize(R.dimen.app_timeline_icon_width);
        j = resources
                .getDimensionPixelSize(R.dimen.app_timeline_icon_height);
        int i1 = resources
                .getDimensionPixelSize(R.dimen.app_margin_small);
        int j1 = resources
                .getDimensionPixelSize(R.dimen.app_margin_small);
        n = resources
                .getDimensionPixelSize(R.dimen.app_margin_small);
        int k1 = resources
                .getDimensionPixelSize(R.dimen.app_text_hint);
        f = resources.getDimensionPixelSize(R.dimen.app_timeline_icon_height);
        int l1 = resources.getColor(R.color.app_link);
