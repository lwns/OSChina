...
public class TweetPicturesLayout extends ViewGroup implements View.OnClickListener {
    ...
    private OnImageClickLisetener lisetener;
    ...
    public void setLisetener(OnImageClickLisetener lisetener) {
    ...
    public void setImage(Image[] images) {
        ...
        if (images != null && images.length > 0) {
            ...
            for (int i = 0; i < images.length; i++) {
                View view = inflater.inflate(R.layout.weight_tweet_image_item, this, false);
                view.setTag(i);
    ...
    interface OnImageClickLisetener {
        void onClick(View v);
    }
